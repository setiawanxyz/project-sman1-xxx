...
$query = mysql_query("DELETE FROM tbkelas WHERE kode_kelas='$kode'") or die(mysql_error());
if ($query) { ?>
<script language="JavaScript">alert('Data Kelas Berhasil DiHapus'); document.location='kelas.php'</script>
<?php }
else{ ?>

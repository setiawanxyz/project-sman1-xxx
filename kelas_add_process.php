...
$query = mysql_query("INSERT INTO tbkelas(nama_kelas,ruang) VALUES('$nama','$ruang')") or die(mysql_error());
if ($query) { ?>
<script language="JavaScript">alert('Data Kelas Berhasil Disimpan'); document.location='kelas.php'</script>
<?php }
else{ ?>

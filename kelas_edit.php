...
?>
		<form action="kelas_edit_process.php" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" value="<?php echo $data['nama_kelas'];?>" name="txtnama" required>
			</div>
			<div class="form-group">
				<label for="ruang">Ruang:</label>
				<input type="text" class="form-control" value="<?php echo $data['ruang'];?>" name="txtruang" required>
			</div>

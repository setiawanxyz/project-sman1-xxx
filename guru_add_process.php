...
$query = mysql_query("INSERT INTO tbguru(nama_guru,alamat,telepon) VALUES('$nama','$alamat','$telepon')") or die(mysql_error());
if ($query) { ?>
<script language="JavaScript">alert('Data Guru Berhasil Disimpan'); document.location='guru.php'</script>
<?php }
else{ ?>

...
<html lang="en">
	<head>
		...
		<script>
			function yakinhapus() {
				alert("Data Guru akan di Hapus, Lanjutkan?");
			}
		</script>
	</head>
	<body>
...
?>
		<form action="guru_delete_process.php" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" value="<?php echo $data['nama_guru'];?>" name="txtnama" readonly>
			</div>
			<div class="form-group">
				<label for="alamat">Alamat:</label>
				<input type="text" class="form-control" value="<?php echo $data['alamat'];?>" name="txtalamat" readonly>
			</div>
			<div class="form-group">
				<label for="telepon">Telepon:</label>
				<input type="text" class="form-control" value="<?php echo $data['telepon'];?>" name="txttelepon" readonly>
			</div>

...
$query = mysql_query("DELETE FROM tbwalikelas WHERE kode_walikelas='$kode'") or die(mysql_error());
if ($query) { ?>
<script language="JavaScript">alert('Data Wali Kelas Berhasil DiHapus'); document.location='walikelas.php'</script>
<?php }
else{ ?>

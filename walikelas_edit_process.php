...
$query = mysql_query("UPDATE tbwalikelas SET nama_guru='$guru', nama_kelas='$kelas', tahun_ajaran='$tahun' WHERE kode_walikelas='$kode'") or die(mysql_error());
if ($query) { ?>
<script language="JavaScript">alert('Data Wali Kelas Berhasil DiUpdate'); document.location='walikelas.php'</script>
<?php }
else{ ?>
